...
//             // console.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", time);
//             // cm 5 4 3 2 1 5
//             // console.log("asdfowejfiowefj", parseInt(row[2].topicItemRegisterDate)+2);
...
//       // var changeState = `UPDATE topicItem SET topicItemState='0' WHERE topicItemState='1' AND topicItemRegisterDate<'${yyyy + '-' + mm + '-' + dd + ' ' + hh + ':' + currentMM+5}'`
...
//                           console.log("3번타임 바뀜")
//                         })
//                       } //else if (row[3].topicItemRegisterDate >= date) 
//                       else {
